...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Publications by the Cognition and Learning Design Lab, in reverse chronological order.",
          section: "Navigation",
          handler: () => {
          ...
          title: "people",
          description: "Members of the Cognition and Learning Design Lab",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-yesnlp-is-looking-for-motivated-phd-and-ms-students-to-join-our-group-in-fall-2025-research-areas-nlp-ai-in-education-information-retrieval-email-dr-noh-to-apply",
          title: 'YesNLP is looking for motivated PhD and MS students to join our group...',
          description: "",
          section: "News",},{id: "news-two-papers-accepted-at-aina-2025-and-ieee-icsc-2025-on-adversarial-cnn-robustness-and-video-learning-analytics-youleqd",
          title: 'Two papers accepted at AINA 2025 and IEEE ICSC 2025 — on adversarial...',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-adversarial-robustness-of-deep-networks",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%6E%6F%68%33@%6B%65%6E%6E%65%73%61%77.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Gxps8DsAAAAJ", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/yesjiho", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/JihoNoh", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Jiho-YesNLP", "_blank");
        },
      },{
      id: 'light-theme',
